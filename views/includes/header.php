...
<body>
	...
	<div id="header">
        ...
        <?php if($this->ion_auth->is_admin()):?>
        	<h2 class="page-title">HHAT Administrative Tool</h2>
        <?php else:?>
        	<h2 class="page-title">HHAT Management Tool</h2>
		<?php endif;?>
        ...
        <div class="right-content">
            ...
            <?php endif;?>
            <a href="<?=base_url('page/reports')?>" data-toggle="tooltip" data-placement="bottom" title="Reports" class="pull-left">
