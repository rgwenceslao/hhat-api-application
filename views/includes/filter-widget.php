...
<div class="paging-tool">
    <div class="pull-left">
        ...
        <form method="get" class="form-inline pull-left form-perpage" action="<?=$datatables['base_url'];?>">
    ...
    <div class="pull-right filter-search">
        <div class="input-group">
            <form method="get" class="form-inline form-search" action="<?=$datatables['base_url'];?>" id="filter_search">
                <input type="hidden" name="field_search" value="<?=implode(',', $field_search)?>" />
                <input type="text" class="form-control" name="keyword" placeholder="Search..." value="<?=$this->input->get('keyword')?>">            
            </form>
            
            <form method="get" class="form-inline form-search" action="<?=$datatables['base_url'];?>">
            ...
            <form method="get" class="form-inline form-search form-calendar hidden" action="<?=$datatables['base_url'];?>">
            	&nbsp;&nbsp;
