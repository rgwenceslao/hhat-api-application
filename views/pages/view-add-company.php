                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-group<?php if(form_error('address')) echo ' has-error';?>">
                                <textarea name="address" class="form-control" rows="4"><?=set_value('address');?></textarea>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-group<?php if(form_error('country')) echo ' has-error';?>">
                                ...
                                echo form_dropdown('country', $options, set_value('country', ( ( !empty($sl_val) ) ? "$sl_val" : '') ), 'class="form-control"' );  
                                ?>
                        ...
                        <td>
                            <div class="form-group">
                                <div class="input-group<?php if(form_error('expiration')) echo ' has-error';?>">
                                    <input type="text" name="expiration" class="form-control expiration_date" value="<?=set_value('expiration');?>"/>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                <input class="btn btn-primary pull-right btn-lg btn-block" type="submit" value="Add Company"/>
                                </div>
                            </div>
                        </td>
                    </tr>
