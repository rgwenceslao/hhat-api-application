                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-group<?php if(form_error('company')) echo ' has-error';?>">
                                ...
                                echo form_dropdown('company', $options, set_value('company', ( ( !empty($sl_val) ) ? "$sl_val" : '') ), 'class="form-control"' );  
                                ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-group<?php if(form_error('contact_no')) echo ' has-error';?>">
                                <input type="text" name="contact_no" class="form-control" value="<?=set_value('contact_no');?>"/>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-group<?php if(form_error('role')) echo ' has-error';?>">
                                ...
                                echo form_dropdown('role', $options, set_value('role', ( ( !empty($sl_val) ) ? "$sl_val" : '') ), 'class="form-control"' );  
                                ?>
